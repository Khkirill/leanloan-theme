			...
			<div className="carousel-block">
				<div className="siema">
					{attributes.items.map(item =>
						<div key={item.id}><Slide item={item}/></div>
					)}
				</div>
				<div className="carousel-controls">
					<button type="button" className="carousel-control carousel-control_side_left">
					...
					<button type="button" className="carousel-control carousel-control_side_right">
						<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
							 width="284.935px" height="284.936px" viewBox="0 0 284.935 284.936">
							<path fill="#5e5e5e" d="M222.701,135.9L89.652,2.857C87.748,0.955,85.557,0,83.084,0c-2.474,0-4.664,0.955-6.567,2.857L62.244,17.133
						c-1.906,1.903-2.855,4.089-2.855,6.567c0,2.478,0.949,4.664,2.855,6.567l112.204,112.204L62.244,254.677

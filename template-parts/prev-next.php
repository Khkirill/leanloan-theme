<?php $prev_next = ln_get_prev_next_posts(); ?>
    ...
    <nav class="post-nav">
            ...
            <?php if ( !empty($prev_next['prev']) ): ?>
                    <a href="<?php echo esc_url( get_permalink( $prev_next['prev'] ) );?>">
                        ...
                        <span class="post-nav__link"><?php echo get_the_title( $prev_next['prev'] );?></span>
                    </a>
            <?php endif; ?>
            </div>
            ...
            <?php if ( !empty( $prev_next['next']) ): ?>
                    <a href="<?php echo esc_url( get_permalink( $prev_next['next'] ) ); ?>">
                        ...
                        <span class="post-nav__link"><?php echo get_the_title( $prev_next['next'] );?></span>
                    </a>
            <?php endif; ?>
            </div>
    </nav>
